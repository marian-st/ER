...
\begin{usecase}
	...
	\additemizedfield{Passi}{
		\item Nel propria dashboard seleziona la finestra per inserire i dati anagrafici dei pazienti
...
\begin{usecase}
	...
	\additemizedfield{Passi}{
		\item Nel propria dashboard seleziona la finestra per aggiungere una somministrazione
