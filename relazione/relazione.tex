...
\item Prende atto della patologia segnalata e del paziente in questione, indicato 
...
\addfield{Postcondizioni:}{L'allarme viene spento. Se il medico non era autenticato e ha inserito correttamente le sue credenziali, rimane autenticato per un certo periodo di tempo}
