...
\begin{figure}[h]
	...
	\node[singlestate, text width= 1.9cm, align=center, name=Fb] at (10.8, -5.8) {Scegli paziente};
	\node[singlestate, text width= 1.9cm, align=center, name=Fc] at (14, -5.8) {Scegli medicinale};
	...
	\draw[->] (10.8,-4) -- (10.8,-5.3);
	\draw[->] (14,-4) -- (14,-5.3);

	\draw[->] (10.8,-6.3) -- (10.8,-7.8);
	\draw[->] (14,-6.3) -- (14,-7.8);
