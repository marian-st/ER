...
\begin{figure}\begin{center}
		...
		\begin{umlcall}[op={\scriptsize{update(c: Command)}}, type=asynchron, dt=14] {c}{b}
		\begin{umlcallself}[op={\scriptsize{stato mutato}}]{b}
		
		\end{umlcallself}
		\begin{umlcall}[op={\scriptsize{onNext(s: State)}}, type=asynchron, dt=2]{b}{a}
		\begin{umlcall}[op={\scriptsize{onNext(s: State)}}, type=asynchron , dt=0]{b}{c}
		\begin{umlcallself}[op={\scriptsize{f1(s)}}]{a}	\end{umlcallself}
		\begin{umlcallself}[op={\scriptsize{f2(s)}}]{c}	\end{umlcallself}
		\end{umlcall}
		\end{umlcall}
		\end{umlcall}
...
\begin{figure}
	\begin{center}
		...
		\umldep[]{StateEvent}{State}
		\umldep[]{StateEvent}{Command}
		\end{umlpackage}  
