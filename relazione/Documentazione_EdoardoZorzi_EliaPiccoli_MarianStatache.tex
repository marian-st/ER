...
\begin{figure}[t]
	...
	\node[ join, text width=60mm, name=F, fill=black, align=center] at(12.5,-4.2) {};
	\node[singlestate, text width= 1.9cm, align=center, name=G] at (7, -6.5) {Ricerca cartella};
	\node[singlestate, text width= 1.9cm, align=center, name=H] at (0, -8.5) {Compila diagnosi};
	\node[singlestate, text width= 1.9cm, align=center, name=I] at (4, -8.5) {Visualizza info};
	\node[singlestate, text width= 1.9cm, align=center, name=J] at (7, -8.5) {Visualizza dati};
	
	\node[singlestate, text width= 1.9cm, align=center, name=Fa] at (9.7, -5.8) {Inserisci farmaco};
	\node[singlestate, text width= 1.9cm, align=center, name=Fb] at (11.2, -7) {Inserisci quantità};
	\node[singlestate, text width= 1.9cm, align=center, name=Fc] at (13.6, -7) {Inserisci n. dosi};
	\node[singlestate, text width= 1.9cm, align=center, name=Fd] at (15.3, -5.8) {Inserisci giorno};
	
	\node[ join, text width=60mm, name=K, fill=black, align=center] at(12.5,-8.5) {};
	...
	\draw[->] (9.75,-4.2) -- (9.75,-5.3);
	\draw[->] (15.2,-4.2) -- (15.2,-5.3);
	\draw[->] (11.2,-4.2) -- (11.2,-6.5);
	\draw[->] (13.5,-4.2) -- (13.5,-6.5);
	
	\draw[->] (9.75,-6.3) -- (9.75,-8.5);
	\draw[->] (15.2,-6.3) -- (15.2,-8.5);
	\draw[->] (11.2,-7.5) -- (11.2,-8.5);
	\draw[->] (13.5,-7.5) -- (13.5,-8.5);
...
\begin{figure}\begin{center}
		...
		\umlobject[class= Controller, fill=blue!10!white ] {a} 
		\umlobject[class= Store, fill=blue!10!white] {b}
		\umlobject[class= Controller, fill=blue!10!white]{c}
		...
		\begin{umlcall}[op={\scriptsize{update(c: Command)}}, type=asynchron, dt=14] {c}{b}\end{umlcall}
		\begin{umlcallself}[op={\scriptsize{stato mutato}},dt=0.8]{b}
		\begin{umlcall}[op={\scriptsize{onNext(se: StateEvent)}}, type=asynchron, dt=4]{b}{a}
		\begin{umlcall}[op={\scriptsize{onNext(se: StateEvent)}}, type=asynchron , dt=0]{b}{c}
		\begin{umlcallself}[op={\scriptsize{f1(se)}}]{a}	\end{umlcallself}
		\begin{umlcallself}[op={\scriptsize{f2(se)}}]{c}	\end{umlcallself}
		
		\end{umlcall}
		\end{umlcall}
		\end{umlcallself}
		
		\fill[white] (3.851,-4.59) -- (4.155,-4.59) -- (4.155,-4.62) -- (3.851, -4.62);
...
\begin{figure}
	%\includegraphics[scale=.06]{ClassDiagramImages/ER.pdf}
