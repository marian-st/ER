...
\begin{figure}
	\begin{center}
		...
		\umldep[stereo=create]{Component}{Interface Factory}
		\umldep[stereo=create]{Component}{Controller Factory}
		\umlunicompo[mult1=1, mult2=*]{InterfacesController}{Component}
		\umlCNunicompo[ mult1=1, mult2=1]{Component}{6.3, -6}{Interface}
